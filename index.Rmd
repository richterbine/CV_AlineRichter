...
if(PDF_EXPORT){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/richterbine/CV_AlineRichter/tree/master/CV_AlineRichter.pdf)")
}
```
